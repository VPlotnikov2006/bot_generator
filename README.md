...
<details>
	...
	Что-бы запустить пробного бота и посмотреть за его работой, в папке Bot_test запустите файл bot.py. В нём введите токен бота, в котором вы хотите работать,
	а далее просто переходите в вашего бота и пропишите /start.
</details>
___
